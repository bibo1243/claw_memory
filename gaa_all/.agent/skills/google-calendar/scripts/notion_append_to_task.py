...
def append_comment_and_image(page_id, comment, image_url):
    blocks = [
        {
            "object": "block",
            "type": "paragraph",
...
if __name__ == '__main__':
    if len(sys.argv) < 4:
        print("Usage: notion_append_to_task.py <db_id> <task_name> <comment> <image_url>")
        sys.exit(1)
    ...
    if task_id:
        ...
        append_comment_and_image(task_id, comment, image_url)
        print("Done.")
    else:
